<template>
  ...
  <v-dialog :fullscreen="$vuetify.breakpoint.smAndDown||componentName==='appPostOrUpdateJob'"
...
<script>
  ...
  import RefuseJobad from "~/components/admin/RefuseJobad";
  import PostOrUpdateJob from "~/components/jobs/PostOrUpdateJob";

  export default {
    name: "AddOrUpdateDialog",
    components: {
      appPostOrUpdateJob:PostOrUpdateJob,
